...
const DistinctColumnValues = () => {
    ...
    useEffect(() => {
        ...
        dispatch(updateProjectDetails({ field: "subModule", value: "Distinct Column Values" }));
    }, []);
    useEffect(() => {
        if (projectDetails.subModule === 'Distinct Column Values') {
            fetchPrev();
            fetchValues();
        }
    }, [projectDetails]);
    ...
    const fetchValues = async () => {
        try {
            ...
            const data = response.data.settings['distinctValues'];
            if (data) {
    ...
    const callAction = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}/api/databaseAnalyticsRoute/distinctColumnValues`, formData, {
                headers: {
...
export default DistinctColumnValues
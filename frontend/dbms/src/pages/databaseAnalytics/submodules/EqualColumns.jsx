...
const EqualColumns = () => {
    ...
    useEffect(() => {
        ...
        dispatch(updateProjectDetails({ field: "subModule", value: "Equal Columns" }));
    }, []);
    useEffect(() => {
        if (projectDetails.subModule === 'Equal Columns') {
            fetchPrev();
            fetchValues();
        }
    }, [projectDetails]);
    ...
    const fetchValues = async () => {
        try {
            ...
            const data = response.data.settings['equalColumns'];
            if (data) {
    ...
    const callAction = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}/api/databaseAnalyticsRoute/equalColumns`, formData, {
                headers: {

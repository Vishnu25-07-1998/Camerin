...
const BasicDetails = () => {
    ...
    useEffect(() => {
        ...
        dispatch(updateProjectDetails({ field: "subModule", value: "Basic Details" }));
    }, []);
    useEffect(() => {
        if (projectDetails.subModule === 'Basic Details') {
            fetchPrev();
        }
    }, [projectDetails]);
    ...
    const callAction = async () => {
        ...
        const endpoints = {
            ...
            "Subset Relations": `${API_URL}/api/databaseAnalyticsRoute/subsetRelation`,
            ...
            "Equal Columns": `${API_URL}/api/databaseAnalyticsRoute/equalColumns`,
            "Distinct POS": `${API_URL}/api/databaseAnalyticsRoute/distinctPOS`,
            "Table Names Gaps Filled": `${API_URL}/api/databaseAnalyticsRoute/tableNamesGap`,
            "Table Names as is Meaning": `${API_URL}/api/databaseAnalyticsRoute/tableNamesMissing`,
        };

        setExecution(true);

        try {
            const response = await axios.post(`${API_URL}/api/databaseAnalyticsRoute/basicDetails`, formData, {
                headers: {

...
const Dataflow = () => {
    ...
    //             `${API_URL}/api/dataflowRoute/prevs`,
    //             { projectDetails },
    //             {
    //                 headers: {
    //                     'Content-Type': 'application/json',
    ...
    const callAction = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}/api/dataflowRoute/dataFlow`, formData, {
                headers: {
    ...
    return (
        <>
            ...
            <main className="module-content relation-module">
                ...
                {imgSrc && <img src={`${API_URL}/${imgSrc}`} alt="ER Diagram" />}
            </main>
        </>
    )
}

...
import styles from '../dataAnomaly.module.css';
...
const DBScan = () => {
    ...
    const fetchPrev = useCallback(async () => {
        try {
            const response = await axios.post(
                `${API_URL}/api/dataAnomalyRoute/prevs`,
                { projectDetails },
                {
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const callAction = async () => {
        ...
        try {
            const response = await axios.post(`${API_URL}/api/dataAnomalyRoute/dbScan`, formData, {
                headers: {

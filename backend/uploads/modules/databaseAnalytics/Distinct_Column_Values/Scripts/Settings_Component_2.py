...
group_name = "\\Distinct_Column_Values"
...
folder_input_name_module_for_filename = ".Tables_and_Columns_Dump"
folder_output_name_module_for_filename = ".Distinct_Column_Values."
star_csv_var = '*.csv'
count_var = 'count'
count_percentage_var = 'count_percentage'
Count_of_Null_Values_var = 'Count of Null Values'
Column_number_var = "Column "
count_of_distinct_values_per_column = 1000

#exec(open(r'C:\Users\USER_ID\OneDrive - COMPANY_NAME Group\_MyHome\user\My Documents\Official\Manhattan\python\main\To_Be_Packaged\Apr_2023_2_Source_distinct_attribute_values_count_v7.py').read(), globals())
